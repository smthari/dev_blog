...
if (isset($_POST['updateUser'])) {
    ...
    if ($tempname != "") {
        $updateQuery = "UPDATE `user` SET `username`='$usernameValue',`password`='$passwordValue',`First`='$fName',`Last`='$lName',`userProfile`='$filename' WHERE id=$id";
    } else {
        $updateQuery = "UPDATE `user` SET `username`='$usernameValue',`password`='$passwordValue',`First`='$fName',`Last`='$lName' WHERE id=$id";
    }
                        ...
                        <form class="needs-validation" action="" method="POST" enctype="multipart/form-data">
                            <div class="row g-3">
                                <div class="col-12 text-center">
                                    <img src="../images/<?php echo $result->userProfile ? $result->userProfile : "artist.png" ?>"
                                        class="img-thumbnail w-50 my-5 rounded-circle" style="width:150px !important;"
                                        alt="Avatar">
                                </div>

                                <!--<?php echo $result->userProfile ? $result->userProfile : "nahi hai" ?>-->
                                ...
                                <button class="btn btn-primary" type="submit" name="updateUser">Update Profile</button>
                            </div>

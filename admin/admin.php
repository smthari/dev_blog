<?php
session_start(); // session started for admin based on uid 
// created two variable and assigned to session variable - we'll use these variables to print on admin home page
          ...
          <div class="row mt-3">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/admin-panel/panel/admin/admin.php">Home</a></li>
